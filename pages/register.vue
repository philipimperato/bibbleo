...
const { mutateAsync: createUser, reset } = api.service('auth/register').create()
...
<template>
  <div class="flex min-h-screen flex-1 bg-gray-900">
    <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div class="block text-2xl font-medium leading-6 text-white">
          Create an Account
        </div>
        ...
        <div class="mt-10 leading-6">
          <div>
            ...
            >
              ...
              <div>
                <label for="email" class="block text-sm font-medium leading-6 text-white">Firstname</label>
                <div class="mt-2">
                  <TextField validation="required" name="firstname" />
                </div>
              </div>

              <div>
                <label for="email" class="block text-sm font-medium leading-6 text-white">Lastname</label>
                <div class="mt-2">
                  <TextField validation="required" name="lastname" />
                </div>
              </div>
              ...
              <div class="py-4">
                <div class="w-[90%] mx-auto border-b border-gray-800"></div>
              </div>
            </FormKit>
          </div>
